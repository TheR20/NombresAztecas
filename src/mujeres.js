...
const bannerSuperiorID = "ca-app-pub-8454341646863233/4606047588";
//Usa la localisacion para saber el idio del telefono
let strings = new LocalizedStrings({
  en:{
    a1:"ingles",
    textodimemasaoru: "New Name",
    textodimemasaoru2: "All Names",
  },
  es:{
    a1:"espa;ol",
textodimemasaoru: "Nuevo Nombre",
textodimemasaoru2: "Todos Los Nombres",
  },
...
export default class App extends Component {
  ...
  state = {
        ...
        loadingen:['Acalan is an Aztec name for boys derived from a small narrow and long rowing boat.'
        ...
        loadingenes:['Acalan es un nombre azteca para niños derivado de un bote de remos pequeño, estrecho y largo'
        ...
        loadingenmujes:['Ahuic es uno de los nombres populares y era el nombre de la diosa azteca del agua corriente en ríos, arroyos y olas'
...
GenerateParrafos2=(genero)=>{
  ...
  numero = RandomNumber;
    ...
    if(strings.a1 == "espa;ol"){
      if(genero == "hombre"){
        this.setState({
          titulo: this.state.loading[numero],

            texto: this.state.loadingenes[numero],


          })
      }else{
        this.setState({
          titulo: this.state.loadingmuj[numero],
            texto: this.state.loadingenmujes[numero],
      ...
      if(genero == "hombre"){
        this.setState({
          titulo: this.state.loading[numero],
            ...
            texto: this.state.loadingen[numero],
        ...
        this.setState({
          titulo: this.state.loadingmuj[numero],
            texto: this.state.loadingenmuj[numero],
...
const image = "https://i.imgur.com/jAvoklO.jpg";

return (
<ImageBackground style={styles.backgroundImage} source={{uri:  image}}>
    <View>
    <Button round uppercase color="#8041DE" size="large"  onPress={() => this.GenerateParrafos2( genero )} >{strings.textodimemasaoru}</Button>
    <Button round uppercase color="#2EAD41" size="large" onPress={() => this.props.navigation.navigate('Completo', { genero:  genero })}>{strings.textodimemasaoru2}</Button>
    <Text style={styles.topBox2}>{ this.state.titulo }</Text>
    <Text style={styles.topBox3}>{ this.state.texto }</Text>
<Text></Text>
<BannerAd
